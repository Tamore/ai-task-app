              ...
              <div key={task._id} className="bg-[var(--color-bg-card)] border border-[var(--color-border-subtle)] rounded-xl p-6 relative overflow-hidden group hover:border-[var(--color-primary)] transition-all duration-300 shadow-sm">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div>
                    ...
                    <p className="text-[var(--color-text-main)] mt-1 bg-[var(--color-bg-base)] border border-[var(--color-border-subtle)] p-3 rounded-md whitespace-pre-wrap break-words max-h-48 overflow-y-auto">{task.inputText}</p>
                  </div>
                  ...
                  {task.status === 'Success' && task.result && (
                    <div className="pt-3 border-t border-[var(--color-border-subtle)] mt-4">
                      ...
                      <p className="text-emerald-700 font-medium bg-emerald-50 p-3 rounded-md border border-emerald-200 whitespace-pre-wrap break-words max-h-48 overflow-y-auto">{task.result}</p>
                    </div>
                  )}
                  ...
                  {task.status === 'Failed' && task.logs && (
                    <div className="pt-3 border-t border-[var(--color-border-subtle)] mt-4">
                      ...
                      <p className="text-red-700 text-sm bg-red-50 p-3 rounded-md border border-red-200 whitespace-pre-wrap break-words max-h-48 overflow-y-auto">{task.logs}</p>
                    </div>
                  )}
                </div>
              </div>
